...
public interface MicrofrontendPlatform {
   ...
   */
  CompletableFuture<AbstractBrowser> startHost(final MicrofrontendPlatformConfig config);
   ...
   */
  CompletableFuture<AbstractBrowser> startHost(final MicrofrontendPlatformConfig config, boolean headless);
